...
use App\Service\CategoryVehicleService;
...
final class CategoryVehicleController extends AbstractController
{
    ...
    public function show(CategoryVehicle|null $category): JsonResponse
    {
    ...
    public function update(Request $request, CategoryVehicle|null $category): JsonResponse
    {
        if (!$category) return new JsonResponse(['error' => 'Not found'], 404);
